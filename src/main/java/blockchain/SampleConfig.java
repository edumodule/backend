...
public class SampleConfig {
    private static final Log logger = LogFactory.getLog(SampleConfig.class);
...
//                    DEFAULT_CONFIG));
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.peer_locations", "peer0.org1.example.com@grpc://localhost:7051, peer1.org1.example.com@grpc://localhost:7056, peer2.org1.example.com@grpc://localhost:7061");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.orderer_locations", "orderer.example.com@grpc://localhost:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.eventhub_locations", "peer0.org1.example.com@grpc://localhost:7053,peer1.org1.example.com@grpc://localhost:7058,peer2.org1.example.com@grpc://localhost:7063");
     ...
     */
    public static SampleConfig getConfig() {
        if (null == config) {
    ...
    public String getTestChannlePath() {
        ...
        return "network/e2e-2Orgs/channel";
